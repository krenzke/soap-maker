...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference("Batch.count") do
      post batches_url, params: { batch: { manufactured_on: @batch.manufactured_on, name: @batch.name, units_produced: @batch.units_produced } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { manufactured_on: @batch.manufactured_on, name: @batch.name, units_produced: @batch.units_produced } }
